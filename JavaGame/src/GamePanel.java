...
public class GamePanel extends JPanel implements ActionListener {
    ...
    public void draw(Graphics g) {
        ...
        if(running) {
            ...
            g.fillOval(prizeX, prizeY, UNIT_SIZE, UNIT_SIZE);
            ...
            g.drawString("Score: "+prizesEaten, (SCREEN_WIDTH - metrics.stringWidth("Score: "+prizesEaten))/2, g.getFont().getSize());
        }
    ...
    public void gameOver(Graphics g) {
        ...
        g.drawString("Score: "+prizesEaten, (SCREEN_WIDTH - metrics1.stringWidth("Score: "+prizesEaten))/2, g.getFont().getSize());
        g.setColor(Color.white);
